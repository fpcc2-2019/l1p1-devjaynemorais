...
## No geral, onde chove mais?
    ...
    Disto isto, é possível observar nos gráficos que na cidade de João Pessoa a média de chuvas (aproximadamente 32.8) é maior que a média de chuvas em Campina Grande (aproximadamente 14.0), apresentando-se maior que o dobro da quantidade em Campina Grande. 
